...
PNI검사는 심리학적으로는 생태학적 양육이론(Bronfenbrenner), 애착이론 (Bowlby), 자기효능감 이론(Bandura), 양육 스트레스 모델(Abidin) 등을 바탕으로 하여, 양육을 단지 '태도'의 문제가 아닌, 관계, 상황, 감정, 과거, 환경이 얽힌 복합적인 과정으로 접근하고 있습니다. PNI검사는 자녀를 양육하는 부모님들로 하여금 정보나 방법 이전에, 자기 자신을 먼저 바라볼 수 있는 거울이 되어주고자 합니다. 부모는 누구나 '완벽'하진 않지만, '성찰하고 성장할 수 있는 존재'입니다. PNI는 바로 그 성장을 위한 출발점이 될 것입니다`}
          </Typography>
        </Box>
